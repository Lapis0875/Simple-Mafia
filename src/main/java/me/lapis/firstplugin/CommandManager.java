...
public class CommandManager implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        this.bukkit_logger = sender.getServer().getLogger();
    ...
    protected boolean info(CommandSender sender, Command command, String label, String[] args){
        ...
        if(sender_p != null) {
            try{
                PluginDescriptionFile pluginDescriptionFile = Bukkit.getPluginManager().getPlugin("Lapis_Plugin").getDescription();
